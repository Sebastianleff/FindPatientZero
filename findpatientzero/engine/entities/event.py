...
#change desc to be a property with random pool of flavor text for relent event type
#change yml events to event types with only frequency, amount, action and condition data.
